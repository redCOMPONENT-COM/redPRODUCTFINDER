...
class RedproductfinderModelType extends JModelAdmin
{
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'Type', $prefix = 'RedproductfinderTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_redproductfinder.edit.type.data', array());
		...
		$this->preprocessData('com_redproductfinder.type', $data);
